...
public class RestService {
    ...
    public HttpResponse executeGet(RequestBuilder request, String endpoint) {
        ...
        if (response == null) {
            Asserts.assertThat("Error while sending request Resending..", false);
        }
        return response;
    }
    ...
    public void verifyResponseCode(HttpResponse response, int code) {
        Asserts.assertThat("Mismatch in Response Code! : " + code, response.getResponseCode().getCode(), is(code));
    }
